      ...
      <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl p-8 md:p-10 z-10 animate-in fade-in zoom-in-95 duration-300 border-t-4 border-[#D71920]">
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full bg-[#D71920] hover:bg-red-700 disabled:bg-red-400 text-white font-bold py-4 rounded-lg transition-all transform active:scale-[0.98] shadow-lg shadow-[#D71920]/30 uppercase tracking-wider text-sm md:text-base flex justify-center items-center gap-2"
          >
            {loading ? (
