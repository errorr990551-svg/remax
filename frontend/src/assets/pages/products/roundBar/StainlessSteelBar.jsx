      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Stainless Steel Round Bar</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Stainless Steel Round Bar</h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl font-bold text-[#0F172A] mb-6">Stainless Steel Round Bar</h2>
          ...
          <div className="p-8 md:p-12 bg-white">
            ...
            {activeTab === 'description' && (
              <div className="space-y-6 text-slate-600 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-500 text-justify">
                <p>REMAX FORGE & FITTINGS is a leading manufacturer and supplier of high-quality Stainless Steel Round Bars. These bars are manufactured using premium-grade stainless steel and advanced production technology to ensure superior strength, corrosion resistance, and long service life. Stainless Steel Round Bars are widely used in industries such as construction, marine, chemical processing, and engineering applications.</p>
                <p>REMAX FORGE & FITTINGS supplies Stainless Steel Round Bars across the globe and maintains strict quality standards during manufacturing. Our bars are produced in compliance with international standards and are available in various sizes and grades to meet customer requirements. Custom specifications and finishes are also available based on client needs.</p>
              </div>
            )}
...
export default StainlessSteelBar;
