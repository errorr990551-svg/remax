      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Nickel Alloy Round Bar</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Nickel Alloy Round Bar</h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl font-bold text-[#0F172A] mb-6">Nickel Alloy Round Bar</h2>
          ...
          <div className="p-8 md:p-12 bg-white">
            {activeTab === 'description' && (
              <div className="space-y-6 text-slate-600 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-500 text-justify">
                <p>REMAX FORGE & FITTINGS manufactures high-quality Nickel Alloy Round Bars designed for applications requiring exceptional corrosion resistance and high-temperature strength. Nickel alloys are widely used in aerospace, marine, chemical processing, and power generation industries.</p>
                <p>Nickel Alloy Round Bars offered by REMAX FORGE & FITTINGS are produced in accordance with international standards and undergo strict quality inspection. These bars are available in different grades, sizes, and finishes to meet specialized industrial requirements.</p>
              </div>
            )}
