      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Alloy Steel Round Bar</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Alloy Steel Round Bar</h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="rounded-lg overflow-hidden shadow-2xl border border-slate-200 bg-white h-[400px] flex items-center justify-center relative group p-10">
             <img 
               src="/images/alloystellbars.jpeg"
               alt="Alloy Steel Round Bar" 
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl font-bold text-[#0F172A] mb-6">Alloy Steel Round Bar</h2>
          ...
          <div className="p-8 md:p-12 bg-white">
            {activeTab === 'description' && (
              <div className="space-y-6 text-slate-600 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-500 text-justify">
                <p>REMAX FORGE & FITTINGS manufactures and supplies high-performance Alloy Steel Round Bars used in demanding industrial environments. These bars are produced using advanced alloy steel compositions that provide improved strength, wear resistance, and thermal stability.</p>
                <p>Alloy Steel Round Bars from REMAX FORGE & FITTINGS are widely used in power plants, oil and gas industries, automotive components, and heavy engineering sectors. They are manufactured according to international standards and are available in different grades and sizes to meet specific application requirements.</p>
              </div>
            )}
