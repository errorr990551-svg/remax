      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-xl md:text-2xl lg:text-3xl font-extrabold tracking-tight text-white leading-tight">
            Threaded Flange Manufacturer in India | TH / THRF / THFF / Screwed Flange | ASME B16.5 | Remax Forge
          </h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 items-center">
          ...
          <div className="rounded-2xl overflow-hidden shadow-xl border border-slate-200 bg-white h-[400px] flex items-center justify-center relative group">
             <img 
               ...
               alt="Threaded Flange ASME B16.5 Class 150 Carbon Steel Manufacturer Mumbai India" 
...
[
        ...
        {/* H2-1: What is a Threaded Flange? */}
        ...
        {/* H2-2: Threaded Flange Standard Specifications */}
        <div id="specifications" className="bg-white rounded-2xl border border-slate-200 p-8 md:p-12 shadow-sm mb-12">
          <h2 className="text-3xl font-extrabold text-[#0F172A] border-l-4 border-[#D71920] pl-3 mb-4">
            Threaded Flange Standard Specifications
          </h2>
          <p className="text-slate-600 mb-8 text-sm md:text-base font-medium">
            Remax Forge & Fittings manufactures forged Threaded Flanges to meet stringent international standards. Our manufacturing processes comply with international norms, offering standard dimensions, thickness tolerances, and drilling patterns as outlined below:
          </p>
...
[
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-8">
            ...
            <div className="lg:col-span-4 bg-slate-50 border border-slate-200 rounded-2xl p-4 flex flex-col items-center justify-center">
              <img 
                ...
                alt="Threaded Flange material grades stainless steel duplex inconel" 
        ...
        {/* H2-4: Threaded Flange Standards & Dimensions */}
        <div className="bg-white rounded-2xl border border-slate-200 p-8 md:p-12 shadow-sm mb-12">
          <h2 className="text-3xl font-extrabold text-[#0F172A] border-l-4 border-[#D71920] pl-3 mb-4">
            Threaded Flange Standards & Dimensions
          </h2>
          <p className="text-slate-600 mb-8 text-sm md:text-base font-medium">
            Our forged Threaded Flanges are engineered according to ASME, ANSI, DIN, EN, JIS, and BS standards. They are designed to suit standard industrial pipes and tubes for oil, gas, refinery, water, and chemical projects. We also offer customization to client-specific drawings and dimensional schedules:
          </p>
          <StandardsTable />
        </div>

        {/* H2-5: ASME B16.5 Threaded Flange Dimensions Table */}
        <div id="dimensions" className="bg-white rounded-2xl border border-slate-200 p-8 md:p-12 shadow-sm mb-12">
          <h2 className="text-3xl font-extrabold text-[#0F172A] border-l-4 border-[#D71920] pl-3 mb-4">
            ASME B16.5 Threaded Flange Dimensions Table
          </h2>
          <p className="text-slate-600 mb-8 text-sm md:text-base font-medium">
            Review our detailed dimensional chart for Class 150# and Class 300# forged Threaded Flanges. Standard dimensions cover Nominal Pipe Size (NPS), outer diameter (OD), thickness, bolt circle, number of bolt holes, bolt diameter, and estimated weights. You can sort columns below for easy reference:
          </p>
          <FlangeDimensionsTable slug="threaded-flange" altText="ASME B16.5 Threaded Flange dimensions chart" />
        </div>
