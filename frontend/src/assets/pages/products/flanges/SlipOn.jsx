...
[
        ...
        {/* H2-2: Slip On Flange Standard Specifications */}
        <div id="specifications" className="bg-white rounded-2xl border border-slate-200 p-8 md:p-12 shadow-sm mb-12">
          <h2 className="text-3xl font-extrabold text-[#0F172A] border-l-4 border-[#D71920] pl-3 mb-4">
            Slip On Flange Standard Specifications
          </h2>
          <p className="text-slate-600 mb-8 text-sm md:text-base font-medium">
            Remax Forge & Fittings manufactures forged Slip On Flanges to meet stringent international standards. Our manufacturing processes comply with international norms, offering standard dimensions, thickness tolerances, and drilling patterns as outlined below:
          </p>
...
[
        ...
        {/* H2-3: Slip On Flange Material Grades */}
        ...
        {/* H2-4: Slip On Flange Standards & Dimensions */}
        <div className="bg-white rounded-2xl border border-slate-200 p-8 md:p-12 shadow-sm mb-12">
          <h2 className="text-3xl font-extrabold text-[#0F172A] border-l-4 border-[#D71920] pl-3 mb-4">
            Slip On Flange Standards & Dimensions
          </h2>
          <p className="text-slate-600 mb-8 text-sm md:text-base font-medium">
            Our forged Slip On Flanges are engineered according to ASME, ANSI, DIN, EN, JIS, and BS standards. They are designed to suit standard industrial pipes and tubes for oil, gas, refinery, water, and chemical projects. We also offer customization to client-specific drawings and dimensional schedules:
          </p>
          <StandardsTable />
        </div>

        {/* H2-5: ASME B16.5 Slip On Flange Dimensions Table */}
        <div id="dimensions" className="bg-white rounded-2xl border border-slate-200 p-8 md:p-12 shadow-sm mb-12">
          ...
          <p className="text-slate-600 mb-8 text-sm md:text-base font-medium">
            Review our detailed dimensional chart for Class 150# and Class 300# forged Slip On Flanges. Standard dimensions cover Nominal Pipe Size (NPS), outer diameter (OD), thickness, bolt circle, number of bolt holes, bolt diameter, and estimated weights. You can sort columns below for easy reference:
          </p>
