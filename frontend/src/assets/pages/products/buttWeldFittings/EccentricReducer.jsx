        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="rounded-lg overflow-hidden shadow-2xl border border-slate-200 bg-white h-[400px] flex items-center justify-center relative group p-10">
             {/* Replace with actual image */}
              <img 
                src="/images/eccentricreducer.jpeg" 
                alt="Eccentric Reducer" 
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl font-bold text-[#0F172A] mb-6">Eccentric Reducer</h2>
            ...
            <div className="space-y-6">
               <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Flat side pipe reduction</h3>
                  </div>
               </div>
               <div className="flex gap-4">
                  <div className="mt-1 bg-red-50 p-2 rounded-full h-fit">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Prevents air entrapment</h3>
                  </div>
               </div>
               <div className="flex gap-4">
                  <div className="mt-1 bg-red-50 p-2 rounded-full h-fit">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Used in pump suction</h3>
                  </div>
               </div>
            </div>
          ...
          <div className="p-8 md:p-12 bg-white">
            ...
            {activeTab === 'description' && (
              <div className="space-y-6 text-slate-600 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-500 text-justify">
                <p>
                  REMAX FORGE & FITTINGS is one of eminent manufacturers and suppliers of high grade Eccentric Reducer. REMAX FORGE & FITTINGS overseas offers a commendable range of Eccentric Reducer, for the prestigious client with competitive price. Export packaging is grade towards the protection, handling and transport of Eccentric Reducer by air or sea freight, as such shares many characteristics with export and transport Eccentric Reducer packing. Backed by a diligent teen of professional, we are engaged in offering an excellent quality range of Eccentric Reducer.
                </p>
                <p>
                  REMAX FORGE & FITTINGS is an Eccentric Reducer stockholders and suppliers, delivering to whole of the world. We are an ISO 9001:2008,ISO 9001-2008, ISO 14001-2004, OHSAS 18001-2007, NSIC-CRISIL, EEPC, and QA-UKAS (ISO 9001-2008), SSI Certified company that follows total Quality Management System. and have been recognized as one of the world’s leading stockists and manufacturer of quality metals for over two decades and are committed to quick responses, unsurpassed quality, competitive pricing, reliable deliveries and an exhaustive inventory. Eccentric Reducer to internationally approved quality standards for application. Eccentric Reducer have excellent quality to fully satisfy customer's requirement. We can offer high quality electro polish fittings. Eccentric Reducer are manufactured in accordance with national and international product standards, While we can also produce fittings as per special specification of our customers. In case of custom size fabricate Eccentric Reducer; the welding is done carried out by qualified personnel.
                </p>
                ...
                <p>
                  REMAX FORGE & FITTINGS is known for the quality of eccentric reducers produced. At REMAX FORGE & FITTINGS the eccentric pipe reducer fitting is manufactured with the smaller outlet off centre to the larger end, which allows it to align with only one side of the inlet. The reducer must be installed with straight side up so that it can prevent trapping air at the pump suction. The eccentric pipe reducers allow simple connection of different sized pipes.
                </p>
