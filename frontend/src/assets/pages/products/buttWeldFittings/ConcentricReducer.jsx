      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Concentric Reducer</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Concentric Reducer Manufacturer in India</h1>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="rounded-lg overflow-hidden shadow-2xl border border-slate-200 bg-white h-[400px] flex items-center justify-center relative group p-10">
             {/* Replace with actual image */}
              <img 
                src="/images/concentric-reducers.webp" 
                alt="Concentric Reducer" 
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl font-bold text-[#0F172A] mb-6">Concentric Reducer</h2>
            ...
            <div className="space-y-6">
               <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Centre aligned size reduction</h3>
                  </div>
               </div>
               <div className="flex gap-4">
                  <div className="mt-1 bg-red-50 p-2 rounded-full h-fit">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Ideal for pump discharge</h3>
                  </div>
               </div>
               <div className="flex gap-4">
                  <div className="mt-1 bg-red-50 p-2 rounded-full h-fit">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Smooth symmetric transition</h3>
                  </div>
               </div>
            </div>
          ...
          <div className="p-8 md:p-12 bg-white">
            ...
            {activeTab === 'description' && (
              <div className="space-y-6 text-slate-600 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-500 text-justify">
                <p>
                  REMAX FORGE & FITTINGS is one of eminent manufacturers and suppliers of high grade Concentric Reducer. REMAX FORGE & FITTINGS overseas offers a commendable range of Concentric Reducer, for the prestigious client with competitive price. Export packaging is grade towards the protection, handling and transport of Concentric Reducer by air or sea freight, as such shares many characteristics with export and transport Concentric Reducer packing. Backed by a diligent teen of professional, we are engaged in offering an excellent quality range of Concentric Reducer.
                </p>
                <p>
                  REMAX FORGE & FITTINGS is an Concentric Reducer stockholders and suppliers, delivering to whole of the world. We are an ISO 9001:2008,ISO 9001-2008, ISO 14001-2004, OHSAS 18001-2007, NSIC-CRISIL, EEPC, and QA-UKAS (ISO 9001-2008), SSI Certified company that follows total Quality Management System. and have been recognized as one of the world’s leading stockists and manufacturer of quality metals for over two decades and are committed to quick responses, unsurpassed quality, competitive pricing, reliable deliveries and an exhaustive inventory. Concentric Reducer to internationally approved quality standards for application. Concentric Reducer have excellent quality to fully satisfy customer's requirement. We can offer high quality electro polish fittings. Concentric Reducer are manufactured in accordance with national and international product standards, While we can also produce fittings as per special specification of our customers. In case of custom size fabricate Concentric Reducer; the welding is done carried out by qualified personnel.
                </p>

                <h3 className="text-xl font-bold text-[#0F172A] mt-8 mb-4 border-b border-slate-200 pb-2">
                  What Is Difference Between Concentric Reducer & Eccentric Reducer?
                </h3>
                <p>
                  REMAX FORGE & FITTINGS is known for the quality of concentric reducers produced. At REMAX FORGE & FITTINGS the Concentric reducers are manufactured with the small and large diameters on opposite ends and joined by a cone shaped transition section. They are available in both seamless and welded construction.
                </p>

                <h3 className="text-xl font-bold text-[#0F172A] mt-6 mb-4">
                  What is the application of concentric reducers?
                </h3>
                <p className="font-semibold text-slate-800">Some uses of concentric reducers are as follows:</p>
                <ul className="list-disc pl-5 space-y-2">
                   <li>Concentric reducers will transition gracefully between the piping and the pump.</li>
                   <li>The concentric reducers help in transporting slurries or abrasive liquids.</li>
                   <li>They are useful in services where cavitation is present.</li>
                   <li>When transporting between flanges or pipes of different ratings and wear protection is necessary, concentric reducers are ideal.</li>
                   <li>Concentric reducers are used in discharge of the pump.</li>
                </ul>
                ...
                <p>
                  REMAX FORGE & FITTINGS is known for the quality of eccentric reducers produced. At REMAX FORGE & FITTINGS the eccentric pipe reducer fitting is manufactured with the smaller outlet off center to the larger end, which allows it to align with only one side of the inlet. The reducer must be installed with straight side up so that it can prevent trapping air at the pump suction. The eccentric pipe reducers allow simple connection of different sized pipes.
                </p>

                <h3 className="text-xl font-bold text-[#0F172A] mt-6 mb-4">
                  What is the application of eccentric reducers?
                </h3>
                <ul className="list-disc pl-5 space-y-2">
                   <li>Keeping big pipes and small pipes together.</li>
                   <li>Reducing noise and vibration at the same time.</li>
                   <li>Requires less installation space.</li>
                   <li>Absorbs pipe wall and fluid borne noise.</li>
                   <li>Less turbulence or material entrapment.</li>
                   <li>Eccentric reducer are used with flat side up in pump suction to avoid cavitation.</li>
                </ul>
              </div>
            )}
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm text-left border-collapse border border-slate-200">
                    <tbody>
                      {[
                        { label: "Type", value: "Butt weld Fitting" },
...
export default ConcentricReducer;