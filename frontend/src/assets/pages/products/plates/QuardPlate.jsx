      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Quard Plates</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Quard Plates</h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="rounded-lg overflow-hidden shadow-2xl border border-slate-200 bg-white h-[400px] flex items-center justify-center relative group p-10">
             ...
             <img 
               src="/images/quard-plates.jpg.jpeg" 
               alt="Quard Plates" 
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl font-bold text-[#0F172A] mb-6">Quard Plates</h2>
            ...
            <div className="space-y-6">
               <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Superior wear resistance</h3>
                  </div>
               </div>
               <div className="flex gap-4">
                  <div className="mt-1 bg-red-50 p-2 rounded-full h-fit">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Easy fabrication properties</h3>
                  </div>
               </div>
               <div className="flex gap-4">
                  <div className="mt-1 bg-red-50 p-2 rounded-full h-fit">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Abrasion resistant steel</h3>
                  </div>
               </div>
            </div>
          ...
          <div className="p-8 md:p-12 bg-white">
            ...
            {activeTab === 'description' && (
              <div className="space-y-6 text-slate-600 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-500 text-justify">
                <p>
                  REMAX FORGE & FITTINGS & Fitting are among the pre-eminent organizations, involved in manufacturers, suppliers, stockists and exporter Quard Plates. Available in different lengths, thicknesses and sizes, these Quard Plates are widely demanded by various industries like food & beverage, chemical, petrochemical, pharmaceutical and cosmetics. In addition to this, we provide tailor-made solution for all our offered Quard Plates as per customers‘ requirements.
                </p>
                
                <h3 className="text-xl font-bold text-[#0F172A] mt-6">What is Quard?</h3>
                <p>
                  Quard 400 is easy to bend, cut, machine and weld (to some extent, it ‘s like processing mild steel). In all thicknesses Quard 400 is combined with an excellent surface finish and close thickness tolerances, providing your final application with a high quality look and accurate design fitting. Quard 400 is ideal to be used in applications like: buckets, crushers, cutting edges, dump trucks, loaders, skips, sieves, feeders, measuring pockets, skips.
                </p>
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm text-left border-collapse border border-slate-200">
                    <tbody>
                      {[
                        { label: "Type", value: "Quard Plates" },
                        { label: "Gauge", value: "Quard 400" },
                        { label: "Thickness", value: "6-50 mm (0.24''- 2'')" },
                        { label: "Width", value: "1500-3100 mm (60-122'')" },
                        { label: "Length", value: "16 m (630'')" },
