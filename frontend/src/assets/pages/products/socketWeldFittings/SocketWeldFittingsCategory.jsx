...
const SocketWeldFittingsManufacturerinIndia = () => {
  const { openQuotePopup } = useQuotePopup();

  const specsRows = [
    { label: "Standard", value: "ASME B16.11, BS 3799, MSS SP-79, MSS SP-83" },
    { label: "Classes", value: "Class 3000# (SCH80), Class 6000# (SCH160), Class 9000# (SCHXXS)" },
    { label: "Size Range", value: "1/8\" to 4\" NPS (Nominal Pipe Size)" },
    { label: "Materials", value: "ASTM A105 (Carbon Steel), A182 F304/L, F316/L (Stainless Steel), Duplex F51, Alloy F11/F22" },
    { label: "Weld Rule", value: "1/16\" (1.6mm) expansion gap per ASME B31.3 is required before welding" },
  ];
      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Socket Weld Fittings Manufacturer in India</span>
          </div>
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-extrabold tracking-tight text-white leading-tight">
            Socket Weld Fittings Manufacturer in India
          </h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12 items-center">
          <div className="rounded-2xl overflow-hidden shadow-xl border border-slate-200 bg-white h-[400px] flex items-center justify-center relative group">
            <img 
              ...
              alt="Socket Weld Fittings Manufacturer in India standard specifications and materials" 
        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-8 md:p-12 shadow-sm mb-12">
          ...
          <div className="space-y-6 text-slate-600 leading-relaxed font-medium text-sm md:text-base">
            <p>Intro: Forged SW fittings for small bore high-pressure lines.</p>
            <p>Products: elbow (90°/45°), tee (equal/reducing), coupling (full/half/reducing), union, cross, cap, reducer insert, nipple.</p>
            <p>Standard: ASME B16.11 (primary); BS 3799, MSS SP-79, MSS SP-83.</p>
            <p>Classes: 3000# (maps to SCH80), 6000# (SCH160), 9000# (SCHXXS).</p>
            <p>Size: 1/8" to 4" (NPS).</p>
            <p>Materials: A105, A182 F304/316/316L/F11/F22/F51/F60.</p>
            <p>Gap weld rule: 1/16" gap per B31.3.</p>
            <p>SW vs BW: SW forged (high pressure small bore) vs BW wrought (large bore, less pressure-sensitive).</p>
            <p>Applications: instrumentation, hydraulics, steam tracing, chemical dosing.</p>
            <p>Full product image grid.</p>
            <p>CTA.</p>
          </div>
        </div>
        ...
        <div id="faq" className="bg-white rounded-2xl border border-slate-200 p-8 md:p-12 shadow-sm mb-12">
          ...
          <FlangeFAQs slug="socket-weld-fittings" />
        </div>
      </div>
    </div>
  );
...
export default SocketWeldFittingsManufacturerinIndia;
