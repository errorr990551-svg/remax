      ...
      <div className="bg-[#0F172A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-slate-400 mb-4">
            ...
            <ChevronRight size={14} />
            <span className="text-[#D71920] font-medium">Socket weld Lateral Tee Fittings</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">Socket weld Lateral Tee Fittings</h1>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-16">
          ...
          <div className="rounded-lg overflow-hidden shadow-2xl border border-slate-200 bg-white h-[400px] flex items-center justify-center relative group p-10">
             ...
             <img 
               src="/images/lateral tee.webp" 
               alt="Socket weld Lateral Tee Fittings" 
          ...
          <div className="flex flex-col justify-center">
            <h2 className="text-3xl font-bold text-[#0F172A] mb-6">Socket weld Lateral Tee Fittings</h2>
            ...
            <div className="space-y-6">
               <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Angular branch pipe connection</h3>
                  </div>
               </div>
               <div className="flex gap-4">
                  <div className="mt-1 bg-red-50 p-2 rounded-full h-fit">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Stress reducing flow design</h3>
                  </div>
               </div>
               <div className="flex gap-4">
                  <div className="mt-1 bg-red-50 p-2 rounded-full h-fit">
                  ...
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Heavy duty lateral tee</h3>
                  </div>
               </div>
            </div>
          ...
          <div className="p-8 md:p-12 bg-white">
            ...
            {activeTab === 'description' && (
              <div className="space-y-6 text-slate-600 leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-500 text-justify">
                <p>
                  REMAX FORGE & FITTINGS is one of eminent manufacturers and suppliers of high-grade Socket weld Lateral Tee Fittings. REMAX FORGE & FITTINGS overseas offers a commendable range of Socket weld Lateral Tee Fittings, for the prestigious client with competitive price. Export packaging is grade towards the protection, handling and transport of Socket weld Lateral Tee Fittings by air or sea freight, as such shares many characteristics with export and transport Socket weld Lateral Tee Fittings packing. Backed by a diligent teen of professional, we are engaged in offering an excellent quality range of Socket weld Lateral Tee Fittings.
                </p>
                <p>
                  REMAX FORGE & FITTINGS is a Socket weld Lateral Tee Fittings stockholders and suppliers, delivering to whole of the world. We are an ISO 9001:2008,ISO 9001-2008, ISO 14001-2004, OHSAS 18001-2007, NSIC-CRISIL, EEPC, and QA-UKAS (ISO 9001-2008), SSI Certified company that follows total Quality Management System. and have been recognized as one of the world’s leading stockists and manufacturer of quality metals for over two decades and are committed to quick responses, unsurpassed quality, competitive pricing, reliable deliveries and an exhaustive inventory. Socket weld Lateral Tee Fittings to internationally approved quality standards for application. Socket weld Lateral Tee Fittings have excellent quality to fully satisfy customer's requirement. We can offer high quality electro polish fittings. Socket weld Lateral Tee Fittings are manufactured in accordance with national and international product standards, while we can also produce fittings as per special specification of our customers. In case of custom size fabricate Socket weld Lateral Tee Fittings; the welding is done carried out by qualified personnel.
                </p>
              </div>
            )}
              ...
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm text-left border-collapse border border-slate-200">
                    <tbody>
                      {[
                        { label: "Type", value: "Socket weld Lateral Tee Fitting" },
...
export default SocketWeldLateralTee;